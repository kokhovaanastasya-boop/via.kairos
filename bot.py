...
BOT_TOKEN = "8850880508:AAHVjmR8X6-K1eaHHzWT-PpNzWJ4iU-3gyA"          # токен от @BotFather
...
START_TEXT = (
    "🖤 <b>ПРАВИЛА ЭТОГО ПРОСТРАНСТВА: ЗДЕСЬ ТЕБЕ МОЖНО ВСЁ.</b>\n\n"
    "Добро пожаловать в <b>«I Allow | Я разрешаю»</b>.\n\n"
    "Я — <b>Анастасия (@via.kairos)</b>.\n"
    "Я выбиваю синдром «хорошей девочки», возвращаю природную дерзость и показываю, "
    "как забирать от жизни и мужчин максимум — без чувства вины и стеснения.\n\n"
    "<b>Здесь мы учимся:</b>\n"
    "✨ Просить и получать легко\n"
    "💸 Пробивать финансовые потолки через раскрепощение и уверенность\n"
    "👠 Уходить красиво, если условия не устраивают\n"
    "💅 Быть дорогой, неудобной и желанной\n\n"
    "━━━━━━━━━━━━━━━━\n\n"
    "🎁 <b>ТВОИ ПОДАРКИ НА ВХОДЕ:</b>\n\n"
    "1️⃣ <b>Гайд «Манифест Наглости»</b> (12 слайдов) — пошаговый план выхода "
    "на высокий чек и избавления от скромности.\n"
    "2️⃣ <b>Интерактивная книга «Финансовый флирт»</b> — 100 готовых фраз, "
    "4 закона и 10 щитов от манипуляций.\n"
    "3️⃣ <b>Доступ к записи</b> на личный разбор / интенсив.\n\n"
    "━━━━━━━━━━━━━━━━\n\n"
    "🔒 <b>Подарки — для подписчиц канала.</b>\n"
    "Подпишись и нажми «Я подписалась» — заберёшь всё сразу 👇\n\n"
    "<i>Включай уведомления 🔔 — скромность здесь больше не живёт.</i>"
)
...
BOTH_TEXT = (
    ...
    "🚀 <b>Формула дохода:</b> Личность → Бренд → Доход.\n"
